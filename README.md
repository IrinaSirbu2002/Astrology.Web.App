...
**layout.html**
    ...
    <ul>
    <li>Closer to astrology, when clicked it takes the user to the main page("/")</li>
    <li>NEO, when clicked it takes the user to the Near Earth Object page("/neo")</li>
    <li>Distance Calculator, when clicked it takes the user to the Distance Calculator page("/distcalc")</li>
    <li>Gallery, a dropdown menu that contains:
      <ul>
        <li>APOD (Astronomy Picture of the Day)</li>
        <li>a link to NASA Image and Video Library</li>
      </ul>
    </li>
    </ul>
    </div>
